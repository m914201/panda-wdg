        ...
        var SimpleSlider = {
            ...
            autoSlide: function () {
                ...
                sint = window.setInterval(function () {
                    ...
                    // -------------------------추가--------------------------
                    $('.dot').removeClass('on')
                    $('.dot').eq(thiscurrent).addClass('on')
                    $('.web_dot').removeClass('on')
                    $('.web_dot').eq(thiscurrent).addClass('on')   
            ...
            dragAction: function (event, num) {
                ...
                if (num > 0) {
                    ...
                    if (setVal.loop || (!setVal.loop && thiscurrent < maxSlide - 1)) {
                        ...
                        // ----------------추가----------------               
                        $('.dot').removeClass('on')
                        $('.dot').eq(thiscurrent-2).addClass('on')  
                        $('.web_dot').removeClass('on')
                        $('.web_dot').eq(thiscurrent-2).addClass('on')                      
                    }
